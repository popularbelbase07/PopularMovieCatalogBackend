...
namespace PopularMovieCatalogBackend.Helpers.ImageLocalStorage
{
    public class ImageStorageServices : IFileStorageServices
    {
        private readonly IWebHostEnvironment env;
        private readonly IHttpContextAccessor httpContextAccessor;

        public ImageStorageServices(IWebHostEnvironment env , IHttpContextAccessor httpContextAccessor)
        {
            this.env = env;
